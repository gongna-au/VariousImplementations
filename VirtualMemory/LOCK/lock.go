...
func (l *LOCK) Get(key string) ([]byte, bool) {
...
func (l *LOCK) RemoveOldest(InMemory []string, NotInMemory []string) {
...
// Add a value to lru
func (l *LOCK) Add(key string, value []byte) {
	// 两种情况
...
// Len the number of cache entries
func (l *LOCK) Schedule(actualCall ...string) int {
	pagefailNum := 0
