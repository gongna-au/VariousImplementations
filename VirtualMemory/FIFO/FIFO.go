...
func (l *FIFO) Get(key string) ([]byte, bool) {
...
// Add a value to lru
func (l *FIFO) Add(key string, value []byte) {
	// 两种情况
...
// Len the number of cache entries
func (l *FIFO) Schedule(actualCall ...string) int {
	pagefailNum := 0
